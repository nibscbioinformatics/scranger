...
if (params$is_test) {
  aggregated_samples <- NormalizeData(aggregated_samples)
  aggregated_samples <- FindVariableFeatures(aggregated_samples, selection.method = "vst")
  aggregated_samples <- ScaleData(aggregated_samples, features = rownames(aggregated_samples))
} else {
